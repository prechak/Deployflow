...
function Header() {
  return (
    <>
<section id="header" className="sm:full sm:h-[704px] bg-Blue-100 sm:flex sm:justify-center  xl:h-[700px] xl:relative xl:align-middle ">
  ...
  <div className="relative z-10 sm:px-4 sm:pt-14 md:p-0 md:mt-[165px] md:w-[643px] md:h-[370px] xl:p-0 xl:mt-[165px] xl:w-[643px] xl:h-[370px] xl:mr-[350px]">
    ...
    <p className="sm:text-Gray-700 sm:text-base sm:font-normal sm:pt-4 md:mt-6 xl:mt-6">
    ...
    <img src={Book} alt="" className="absolute md:hidden  xl:top-0 xl:left-0 xl:mt- xl:ml-[667px] xl:block" />
  </div>
</section>
